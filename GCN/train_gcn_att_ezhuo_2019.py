...
from models.gcn_dense_att import GCN_Dense_Att as GCN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='RESULTS_MODELS/awa-att')
    ...
    graph =json.load(open('materials/AWA2/animals_graph_grouped.json'))
    ...
    gcn = GCN(n, edges_set, word_vectors.shape[1], fc_vectors.shape[1], hidden_layers).cuda()
